...
function About() {
  ...
  return (
    <main className='about'>
      ...
      <h2>Навигация</h2>
      <p>
        В разделе "Все турниры" находится таблица со всеми добавленными
        турнирами. Можно отфильтровать по алфавиту, дате и тд. И открыть любой
        из них <br /> <br />
        ...
        <br />
        В "Профиле" (доступен после авторизации), кроме результатов Игрового
        режима,можно увидеть добавленные пользователем турниры, краткую
        информацию, а также сменить пароль.
        <br /> <br />
        На странице "Добавить турнир", можно добавить турнир из Базы вопросов
        самостоятельно. Есть инструкция как это сделать <br /> <br />
        Раздел "Войти" соответственно для авторизации или регистрации.
        Подтверждения почты нет, так что просто введите любой выдуманный email.
      </p>
